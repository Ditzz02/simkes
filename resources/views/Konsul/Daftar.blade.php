                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">{{ $dosen->firstItem() + $index }}</th>
                                        <td>{{ $d->nidn }}</td>
                                        <td>{{ $d->name }}</td>
                                        <td>{{ $d->jurusan }}</td>
                                        <td>{{ $d->jabatan }}</td>
                                        <td>
                                            @if ($d->foto)
                                            <img src="{{ asset('storage/'.$d->foto) }}" alt="Foto Dosen" style="width: 35px; height: auto;">
                                            @else
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('atur-bimbingan',[$d->id]) }}" class="btn btn-info"><i class="bx bxs-edit">Atur Bimbingan</i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
